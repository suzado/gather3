...
import { Calendar, Users, Zap, ArrowRight, Sparkles, Wallet, UserPlus, PlusCircle, Heart } from "lucide-react";
      ...
      <section className="py-24 relative">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="mt-4 text-muted-foreground max-w-xl mx-auto">
              Get started in minutes. All you need is a wallet and some testnet ETH.
            </p>
          </motion.div>
            ...
            {steps.map((step, i) => (
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  <div className="flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-br from-violet-600 to-blue-600 text-sm font-bold text-white shrink-0">
                    {step.number}
                  </div>
